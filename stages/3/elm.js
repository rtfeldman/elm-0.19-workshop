...
Elm.ElmHub.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "SetQuery") {
            return {ctor: "_Tuple2",_0: _U.update(model,{query: _p0._0}),_1: $Effects.none};
         } else {
            var newModel = _U.update(model,{results: A2($List.filter,function (_p1) {    var _p2 = _p1;return !_U.eq(_p2.id,_p0._0);},model.results)});
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.header,
              ...
              ,A2($Html.button,_U.list([$Html$Attributes.$class("search-button")]),_U.list([$Html.text("Search")]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("results")]),A2($List.map,viewSearchResult(address),model.results))]));
   });
   var initialModel = {query: "tutorial"
                      ,results: _U.list([{id: 1,name: "TheSeamau5/elm-checkerboardgrid-tutorial",stars: 66}
   ...
   var app = $StartApp.start({view: view,update: update,init: {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none},inputs: _U.list([])});
   var main = app.html;
